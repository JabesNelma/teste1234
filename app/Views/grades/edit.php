...
<div class="card">
    <div class="card-header"><i class="bi bi-pencil me-2"></i>Edit Grade</div>
    <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-3 mb-3">
                    ...
                    <select name="academic_term" id="academic_term" class="form-select" required>
                        <option value="Term 1" <?= $grade['academic_term'] === 'Term 1' ? 'selected' : '' ?>>Term 1</option>
                        <option value="Term 2" <?= $grade['academic_term'] === 'Term 2' ? 'selected' : '' ?>>Term 2</option>
                        <option value="Term 3" <?= $grade['academic_term'] === 'Term 3' ? 'selected' : '' ?>>Term 3</option>
                    </select>
                </div>
                <div class="col-md-3 mb-3">
                ...
                <div class="col-md-3 mb-3">
                    ...
                    <input type="number" name="score" id="score" class="form-control" min="0" max="100" step="0.01" value="<?= old('score', $grade['score']) ?>" required>
                </div>
            </div>
