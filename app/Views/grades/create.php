...
<div class="card">
    <div class="card-header"><i class="bi bi-plus-circle me-2"></i>Aumenta Valor</div>
    <div class="card-body">
        ...
        <form action="<?= site_url('grades/store') ?>" method="POST">
            ...
            <div class="row">
                <div class="col-md-4 mb-3">
                    ...
                    <select name="class_id" id="class_id" class="form-select" required>
                        <option value="">Hili Class</option>
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <select name="student_id" id="student_id" class="form-select" required>
                        ...
                        <?php if (!empty($students)): ?>
                            ...
                            <?php endforeach; ?>
                        <?php else: ?>
                            <option value="">Primeiru Hili Klasse</option>
                        <?php endif; ?>
                    </select>
                </div>
                <div class="col-md-4 mb-3">
            ...
            <div class="row">
                <div class="col-md-3 mb-3">
                    <label for="academic_term" class="form-label">Periodu*</label>
                    <select name="academic_term" id="academic_term" class="form-select" required>
                        <option value="">Hili Periodu</option>
                        <option value="Term 1" <?= old('academic_term') === 'Term 1' ? 'selected' : '' ?>>Periodu 1</option>
                        <option value="Term 2" <?= old('academic_term') === 'Term 2' ? 'selected' : '' ?>>Periodu 2</option>
                        <option value="Term 3" <?= old('academic_term') === 'Term 3' ? 'selected' : '' ?>>Periodu 3</option>
                    </select>
                </div>
                <div class="col-md-3 mb-3">
                ...
                <div class="col-md-3 mb-3">
                    ...
                    <input type="number" name="score" id="score" class="form-control" min="0" max="10" step="0.1" value="<?= old('score') ?>" required>
                </div>
            </div>

            <div class="d-flex gap-2">
                <button type="submit" class="btn btn-primary"><i class="bi bi-save me-1"></i>Rai Dadus Valor</button>
                <a href="<?= site_url('grades') ?>" class="btn btn-secondary"><i class="bi bi-arrow-left me-1"></i>Fila Fali ba Lista Valor</a>
            </div>
        </form>
    </div>
</div>
