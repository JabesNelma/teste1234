...
<div class="card">
    <div class="card-header"><i class="bi bi-pencil me-2"></i>Edit Class</div>
    <div class="card-body">
        ...
        <form action="<?= site_url('classes/update/') ?><?= $class['id'] ?>" method="POST">
            ...
            <div class="d-flex gap-2">
                <button type="submit" class="btn btn-primary"><i class="bi bi-save me-1"></i>Update Class</button>
